...
Secara sederhana, **Dot Plot bisa dianggap sebagai Bar Chart yang ditumpuk**, tetapi **menggunakan titik** sebagai pengganti batang. Jika kita menggunakan **Bar Chart untuk membandingkan dua kategori dalam satu grup**, batang bisa saling menutupi atau sulit dibandingkan, terutama jika nilainya berdekatan. Dengan **Dot Plot**, setiap kategori diwakili oleh **satu titik**, dan **garis penghubung** antara titik-titik membantu menunjukkan perbedaannya dengan lebih jelas.
...
Misalnya, dalam visualisasi ini, **Dot Plot menggambarkan perbandingan skor PISA untuk Math dan Reading di 10 negara OECD**. Jika menggunakan **Bar Chart**, kita akan mendapatkan **dua batang untuk setiap negara**, yang bisa membuat perbandingan antar kategori kurang intuitif. Dengan Dot Plot:

-   **Setiap negara memiliki dua titik (satu untuk Math, satu untuk Reading)**.

-   **Garis penghubung antara titik membantu menunjukkan selisih antara kedua kategori** dalam satu negara.

-   **Jika titik Math lebih ke kanan, berarti skor Math lebih tinggi dari Reading, dan sebaliknya**.

Jadi, **Dot Plot adalah alternatif dari Bar Chart ketika kita ingin membandingkan dua atau lebih kategori dalam satu grup tanpa risiko batang saling menutupi**, serta memberikan visualisasi yang lebih rapi dan mudah dipahami.
